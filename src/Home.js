    ...
    <>
      ...
      <div className="h-screen relative" id="home">
        ...
        <img
          ...
          style={{
            objectFit: 'contain', // استخدام contain لضمان ظهور الصورة بالكامل
            objectPosition: 'center', // المركز إذا كانت هناك مساحات فارغة
          }}
        />
      )} */}
                  {/* <img
...
export default Home;
  ...
  //               className={index === currentFeedIndex ? "block" : "hidden"}
  //             >
  //               <div className="relative h-screen w-full card-animation "
  //               //////
  //                 style={{ backgroundColor: feed.backgroundColor }}>
  //                 <img
  //                   src={feed.image}
  //                   alt={feed.title}
  //                   className="absolute inset-0 w-full h-full object-cover card-animation"
                   
  //                 />
  //                 <div className="absolute inset-0 bg-black/40 card-animation" 
  //                 // ///////
  //                 style={{ backgroundColor: feed.backgroundColor }}
  //                 />

  //                 <div
  //                   className={` card-animation relative z-10 h-full flex flex-col items-center justify-center text-white p-4 ${
  //                     isSmallScreen ? "px-2" : "px-6"
  //                   }`}
  //                 >
  //                   <h2
  //                     className={`font-bold card-animation mb-4 ${
  //                       isSmallScreen
  //                         ? "text-2xl"
  //                         : isMediumScreen
  //                         ? "text-4xl"
  ...
  //                   </h2>
  //                   <p
  //                     className={`max-w-2xl card-animation text-center ${
  //                       isSmallScreen ? "text-base" : "text-lg md:text-2xl"
  //                     }`}
  //                   >
  //                     {feed.description}
  ...
  //                 borderRadius: "50%",
  //                 backgroundColor:
  //                   index === currentFeedIndex ? "#fff" : "rgba(255, 255, 255, 0.5)",
  //                 margin: "0 5px",
  //                 cursor: "pointer",
  //                 pointerEvents: "auto",
  //               }}
